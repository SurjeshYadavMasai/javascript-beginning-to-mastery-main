...
//❣️❣️The sort() method sorts the elements of an array
...
// / then comparing their sequences of UTF-16 code units
...
// lowToHigh
const lowToHigh = products.slice(0).sort((a, b) => { //clone and sort
  return a.price - b.price;
});
// HighToLow
const highToLow = products.slice(0).sort((a, b) => {  //clone and sort
